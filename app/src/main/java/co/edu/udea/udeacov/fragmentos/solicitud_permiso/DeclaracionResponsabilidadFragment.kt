...
class DeclaracionResponsabilidadFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnVerDeclaracionDeCompromiso.setOnClickListener {
           findNavController().navigate(R.id.action_declaracion_de_responsabilidad_to_aprobacionesDeclaracionDeResponsabilidad)
        }
    ...
    private fun startDownloading() {
        val url = "http://www.udea.edu.co/wps/wcm/connect/udea/755c2d62-727a-48cc-ba24-5b775c4115d0/VA-TH-IN-02.pdf?MOD=AJPERES&CVID=ndpHhO7&attachment=true&id=1594938166306"
